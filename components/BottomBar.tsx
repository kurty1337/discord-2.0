...
const BottomBar: React.FC<BottomBarProps> = ({ isMicOn, isCameraOn, isScreenSharing, onToggleMic, onToggleCamera, onToggleScreenShare, onEndCall }) => {
    return (
        <div className="bg-[#292b2f] p-3 flex items-center justify-center space-x-4 text-white">
            ...
            <ControlButton onClick={onToggleCamera} isEnabled={isCameraOn} title={isCameraOn ? "Выключить камеру" : "Включить камеру"}>
...
const ScreenShareIcon = () => (<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>);
